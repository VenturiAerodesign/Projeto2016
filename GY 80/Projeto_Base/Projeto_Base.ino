...
void setup()
{
  ...
  Serial.println("Temperatura  Pressao  Atm Padrao  Altitude  X(acel.)  Y(acel.)  Z(acel.)  X(giro.)  Y(giro.)  Z(giro.)");
  Serial.println("C  Pa  Atm  m  m  m  m  graus/s  graus/s  graus/s");  
}
